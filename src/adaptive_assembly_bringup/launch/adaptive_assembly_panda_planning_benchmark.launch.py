"""Launch the deterministic Panda planning benchmark profile."""
...
def generate_launch_description() -> LaunchDescription:
    """Start the Panda planning demo with seeded benchmark parameters."""
    ...
    return LaunchDescription([
        LogInfo(
            msg='Launching seeded adaptive assembly Panda planning benchmark: '
            'deterministic fake perception with random_seed=42 for '
            'reproducible planning diagnostics benchmarks. Trajectories are '
            'still not executed.'
        ),
