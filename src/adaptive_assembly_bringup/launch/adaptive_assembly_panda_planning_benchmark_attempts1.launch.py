"""Launch seeded Panda planning benchmark with one planning attempt."""
...
def generate_launch_description() -> LaunchDescription:
    """Start the benchmark profile with num_planning_attempts=1."""
    ...
    return LaunchDescription([
        LogInfo(
            ...
            'num_planning_attempts=1 and scaling factors=1.0. '
