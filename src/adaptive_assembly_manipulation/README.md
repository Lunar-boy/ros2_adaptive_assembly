...
success to open/detach. The Gazebo layer follows `world -> panda_hand` while
attached and leaves the object at its last world pose when detached.
...
Gazebo attachment uses repeated set-pose calls and is not physics-accurate. This
package does not control a physical gripper, alter contact physics, or support
real hardware.
