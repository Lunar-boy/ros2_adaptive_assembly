"""Adapt task-level assembly poses into the Panda planning frame."""
...
def generate_launch_description() -> LaunchDescription:
    """Start the Panda assembly pose adapter without launching MoveIt2."""
    return LaunchDescription([
        ...
        Node(
            ...
            executable='panda_assembly_pose_adapter_node',
            name='panda_assembly_pose_adapter_node',
            output='screen',
            parameters=[{
                'use_sim_time': ParameterValue(
                    LaunchConfiguration('use_sim_time'), value_type=bool
                ),
                'input_topic': '/assembly_pose',
                'output_topic': '/panda_assembly_pose',
