...
check_topic_type "/assembly_sequence_stage_status" "std_msgs/msg/String"
check_topic_type "/assembly_sequence_stage_success" "std_msgs/msg/Bool"
check_topic_type "/assembly_sequence_stage_duration_ms" "std_msgs/msg/Float64"

echo "PASS: all assembly sequence stage diagnostic topics are available"
